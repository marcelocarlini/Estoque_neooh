    ...
    <div class="container" style="margin-top:25px;">
        ...
        <div class="row align-items-start" class="col align-self-center">
            ...
            <div class="col-sm-10" style="margin-top: 25px;">
                <div class="card ">
                    <div class="card-body">
                        <h5 class="card-title"><i class="fas fa-cart-plus"></i>&nbsp;Adicionar Player</h5>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">git
                                            ...
                                            <div class="col-6">
                                                <form class="row g-3" action={{ route('app.player.cadastroplayer') }}
                                                    method="get">
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <select id="inputState" class="form-select" name='modelo'>
                                                            <option value="1">Dell Optiplex 3000</option>
                                                            <option value="2">Dell Optiplex 3090</option>
                                                            <option value="3">Beelink T4 PRO</option>
                                                            <option value="4">Mitsushiba</option>
                                                            <option value="5">Everex</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-12">
